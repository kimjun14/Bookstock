        ...
        <div className="category-list">
            <ul>
                {categories.map((category, in_dex) => (
                    ...
                    >
                        {category.name}<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="bi bi-chevron-compact-right" viewBox="0 0 16 16">
                            <path fillRule="evenodd" d="M6.776 1.553a.5.5 0 0 1 .671.223l3 6a.5.5 0 0 1 0 .448l-3 6a.5.5 0 1 1-.894-.448L9.44 8 6.553 2.224a.5.5 0 0 1 .223-.671" /> {/* stroke-width를 조절 */}
                        </svg>
                    </li>
                ))}
            </ul>
