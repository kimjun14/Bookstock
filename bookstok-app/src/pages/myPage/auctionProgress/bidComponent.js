                                            ...
                                            <div className="row g-0">
                                                <div className="col-md-12">
                                                    <div className="card-body row align-items-center">
                                                        ...
                                                        <h6 className="card-title col mt-3">{Number(bid.bidprice).toLocaleString()} 원</h6>
                                                    </div>
                                                </div>
                                                ...
                                                <div className='card-body row ms-1'>
                                                    <div className="alert alert-light col-sm-12" role="alert">
                                                        <div className='row justify-content-center'>
                                                            <img src={bid.bidImgSrc} className="img-fluid" alt="..." style={{width: "65%"}}/>
                                                        </div>
                                            ...
                                            <div className="row g-0">
                                                <div className="col-md-12">
                                                    <div className="card-body row align-items-center">
                                                        ...
                                                        <h6 className="card-title col-sm-2 mt-1">{Number(bid.bidprice).toLocaleString()} 원</h6>
